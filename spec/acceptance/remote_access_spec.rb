...
# needs a server agent setup
#describe 'remote-access', unless: (UNSUPPORTED_PLATFORMS.include?(os[:family]) or true) do
#  before(:each) do
...
#      hosts_as('database').reduce({}) do |_memo, host|
...
#        apply_manifest_on(host, pp_one, catch_failures: true)
#      end
#    end
#
...
#        apply_manifest_on(host, pp_two, catch_failures: true)
#      end
#    end
#  end
#end
