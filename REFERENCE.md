...
* [`instance_username`](#-postgresql--server--instance--initdb--instance_username)
...
##### <a name="-postgresql--server--instance--initdb--instance_username"></a>`instance_username`

Data type: `Optional[String[1]]`

username of user running the postgres instance

Default value: `$postgresql::server::instance_username`
